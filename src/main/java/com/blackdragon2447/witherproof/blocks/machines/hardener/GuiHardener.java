...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Main.MODID + ":textures/gui/container/hardener.png");
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityHardener.isBurning(tileentity))
		{
			...
			this.drawTexturedModalRect(this.guiLeft + 13, this.guiTop + 44 + 12 - k, 176, 13 - k, 14, k + 1);
		}
