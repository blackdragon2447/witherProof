...
{
	private TileEntityHardener tileentity = new TileEntityHardener();
	...
	public ContainerHarderner(InventoryPlayer player, TileEntityHardener tileentity) 
	{
		...
		this.addSlotToContainer(new SlotItemHandler(handler, 0, 54, 23));
		this.addSlotToContainer(new SlotItemHandler(handler, 1, 54, 46));
		this.addSlotToContainer(new SlotItemHandler(handler, 2, 12, 60));
